...
parent: 2023
permalink: /docs/TodayILearned/2023/23_02
---

- [23.02.28](#230228)
  - [WebRTC 동작 원리](#webrtc-동작-원리)
  - [서버 종류](#서버-종류)
    - [Mesh (Signalling Server)](#mesh-signalling-server)
    - [SFU (Selective Forwarding Unit Server)](#sfu-selective-forwarding-unit-server)
    - [MCU (Multi-point Control Unit Server)](#mcu-multi-point-control-unit-server)
- [23.02.27](#230227)
  - [WebRTC](#webrtc)
    - [The signaling server](#the-signaling-server)
- [23.02.26](#230226)
  - [Node.js](#nodejs)
- [23.02.24](#230224)
